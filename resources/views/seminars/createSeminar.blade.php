    ...
    <div class="row">    
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading"><h2>Pendaftaran Peserta Seminar</h2>Data yang anda masukkan akan digunakan pada sertifikat</div>
                    <div class="panel-body">
                        ...
                        {{ Form::open(['url' => 'SeminarWorkshop/storeSeminar', 'method' => 'post']) }}
